...
**Nat-cat에서 Lasso를 이용해 변수들 select하기**

- 우선 Lasso 회귀분석을 통해 의미없는 변수를 골라낸다.
...
- Lasso 회귀분석을 통해 selection한 변수들을 바탕으로 glm 회귀분석을 하였다. 
  - 그 결과, `region.asia`는 *, `sector.public`은 **으로 p값 수준이 나왔으며, 나머지는 기각할 수준의 p값이 추출되었다. 
  - 



> 💬 GLM을 할 때, 종속변수에 log를 취한 후에 회귀 분석을 해야하는가?
>
> - 
>
